...
const SEED_TN = [
  ...
  { id:7, vn:"Mustername", nn:"7", init:"M7", color:"#c2418c",
    kurs:"TPD 26 I", fachKey:"tpd", fach:"PGK", standort:"Riesa", standortK:"RT",
    ...
    str:"Musterstr. 5", plz:"01587", ort:"Riesa",
...
const SEED_UNTERNEHMEN = [
  ...
  { id:6, name:"Musterfirma 6", init:"6", color:"#5a6781",
    fach:["MAK","PGK"], str:"Musterstr. 8", plz:"01589", ort:"Riesa",
    tel:"03525 600-0", email:"info@musterfirma6.de",
    aktiv:false, koop:false, koopSeit:null,
    filialen:[ { ort:"Riesa", fach:["MAK","PGK"] } ],
    ansprech:[
...
const SEED_USERS = (() => {
  ...
  const list = [
    ...
    mk("Musterkollege 21","Verwaltung","Leser","Riesa"),
